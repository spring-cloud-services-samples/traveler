...
+
....
$ cf set-env company CF_TARGET black.wise.com
Setting env variable 'CF_TARGET' to 'black.wise.com' for app company in org myorg / space outer as user...
OK
...
+
....
$ cf set-env agency CF_TARGET black.wise.com
Setting env variable 'CF_TARGET' to 'black.wise.com' for app agency in org myorg / space outer as user...
OK
TIP: Use 'cf restage' to ensure your env variable changes take effect
$ cf restage agency
....
